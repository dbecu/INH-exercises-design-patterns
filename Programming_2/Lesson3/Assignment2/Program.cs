...
namespace Assignment2
{
    ...
    class Program
    {
        ...
        {
            List<string> listOfWord = new List<string>(); //add more words
            //listOfWord.Add("awkward");
            //listOfWord.Add("bagpipes");
            //listOfWord.Add("banjo");
            //listOfWord.Add("bungler");
            //listOfWord.Add("croquet");
            //listOfWord.Add("dwarves");
            //listOfWord.Add("haiku");
            //listOfWord.Add("ivory");
            //listOfWord.Add("jiffy");
            //listOfWord.Add("kayak");
            //listOfWord.Add("mystify");
            //listOfWord.Add("polka");
            //listOfWord.Add("quip");
            //listOfWord.Add("toady");
            //listOfWord.Add("unzip");
            //listOfWord.Add("waxy");
            //listOfWord.Add("quad");
            listOfWord.Add("zombie");
            listOfWord.Add("oxygen");
            listOfWord.Add("ostracize");
